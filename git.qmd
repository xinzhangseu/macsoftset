...
![](images/Screen%20Shot%202020-03-14%20at%2011.30.19%20PM.png)
...
![](images/Annotation%202020-03-04%20103831.png)

如果我们新建了一个文件,然后再次查看状态:

因为我们还没有将其添加到暂存区,因此显示该新建文件为 `Untracted files`

![](images/Annotation%202020-03-04%20103937.png)

将文件放入暂存区,然后再查看状态:

![](images/Annotation%202020-03-04%20104126.png)

然后再将其进行提交,查看状态.

![](images/Annotation%202020-03-04%20104709.png)
...
![](images/Annotation%202020-03-04%20105306.png)

可以看到记录了对该文件的修改内容.

> 注意,如果你修改之后已经将其存入暂存区,则`git diff`不会再显示内容.

![](images/Annotation%202020-03-04%20105454.png)
...
![](images/Annotation%202020-03-04%20110543.png)
...
![](images/Annotation%202020-03-04%20112427.png)
...
![](images/Annotation%202020-03-04%20112527.png)
