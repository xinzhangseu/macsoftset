...
2.  填入自己的账户名,邮箱和密码.
    ...
    ![](images/Screen%20Shot%202020-03-14%20at%2011.30.19%20PM.png){width=100%}
...
![](images/Screen%20Shot%202020-03-17%20at%2010.13.13%20PM.png)
...
![](images/Annotation%202020-03-04%20103831.png){width=100%}

如果我们新建了一个文件,然后再次查看状态:

因为我们还没有将其添加到暂存区,因此显示该新建文件为 `Untracted files`

![](images/Annotation%202020-03-04%20103937.png){width=100%}

将文件放入暂存区,然后再查看状态:

![](images/Annotation%202020-03-04%20104126.png){width=100%}

然后再将其进行提交,查看状态.

![](images/Annotation%202020-03-04%20104709.png){width=100%}
...
![](images/Annotation%202020-03-04%20105306.png){width=100%}

可以看到记录了对该文件的修改内容.

> 注意,如果你修改之后已经将其存入暂存区,则`git diff`不会再显示内容.

![](images/Annotation%202020-03-04%20105454.png){width=100%}
...
![](images/Annotation%202020-03-04%20110543.png){width=100%}
...
![](images/Annotation%202020-03-04%20112427.png){width=100%}
...
![](images/Annotation%202020-03-04%20112527.png){width=100%}
...
![](images/Annotation%202020-03-04%20112956.png)

然后将其删除掉.

![](images/Annotation%202020-03-04%20113351.png)
...
![](images/Annotation%202020-03-04%20204036.png)
...
![](images/Annotation%202020-03-04%20205634.png)
...
![](images/Annotation%202020-03-04%20210006.png)
...
![](images/Annotation%202020-03-04%20210500.png)

我们下面在development分支下面再新建一个`development.txt`文件,然后写入一些内容.

![](images/Annotation%202020-03-04%20211512.png)
...
![](images/Annotation%202020-03-04%20212532.png)
...
![](images/Screen%20Shot%202020-03-11%20at%209.25.20%20PM.png)

这时候我们可以使用`vi`或者其他工具打开冲突的文件,在这就是`readme.txt`:

![](images/Screen%20Shot%202020-03-11%20at%209.32.06%20PM.png)
...
![](images/Annotation%202020-03-04%20213542.png)
...
![](images/Annotation%202020-03-04%20214807.png)

以后再推送的时候,就使用`git push`就可以了.

这时候可以看到github中已经有了内容.

![](images/Annotation%202020-03-04%20214930.png)
...
![](images/Screen%20Shot%202020-03-27%20at%2010.16.52%20AM.png)

### Accept the invitation

I will send a collaborator invitation email to Han, you will receive this email and please recept the inviation.

![](images/Screen%20Shot%202020-03-27%20at%209.55.43%20AM.png)
...
![](images/Screen%20Shot%202020-03-27%20at%2010.32.52%20AM.png)
